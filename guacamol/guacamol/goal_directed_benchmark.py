...
from guacamol.guacamol.goal_directed_score_contributions import (
...
from guacamol.guacamol.utils.chemistry import (
    canonicalize_list,
    remove_duplicates,
...
class GoalDirectedBenchmark:
    ...
    def __init__(
        ...
        objective_start: ScoringFunction = None,
        ...
        #  objective_start=objective
        self.objective_start = objective_start
        self.wrapped_objective_start = ScoringFunctionWrapper(
            scoring_function=objective_start
        )
    ...
    def assess_model(self, model: GoalDirectedGenerator) -> GoalDirectedBenchmarkResult:
        ...
        molecules = model.generate_optimized_molecules(
            ...
            scoring_function_start=self.wrapped_objective_start,
        ...
        scores = self.objective_start.score_list(unique_molecules)
