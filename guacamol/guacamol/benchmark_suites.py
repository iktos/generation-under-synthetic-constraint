...
from guacamol.guacamol.standard_benchmarks_iktos import (
    pi3kmtor_bench,
    logP_benchmark_iktos,
    cns_mpo_iktos,
    tpsa_benchmark_iktos,
    qed_benchmark_iktos,
    hard_osimertinib_and_synth,
    hard_fexofenadine_and_synth,
    ranolazine_mpo_and_synth,
    perindopril_rings_and_synth,
    amlodipine_rings_and_synth,
    sitagliptin_replacement_and_synth,
    zaleplon_with_other_formula_and_synth,
    valsartan_smarts_and_synth,
    decoration_hop_and_synth,
    scaffold_hop_and_synth,
    isomers_c7h8n2o2_and_synth,
    similarity_and_synth,
)


def goal_directed_benchmark_suite(
    version_name: str, synth_score: Optional[str]
