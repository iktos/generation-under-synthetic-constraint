...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_data",
        default="guacamol_baselines/data/guacamol_v1_train.smiles",
        help="Full path to SMILES file containing training data",
    )
    parser.add_argument(
        "--valid_data",
        default="guacamol_baselines/data/guacamol_v1_valid.smiles",
    ...
    parser.add_argument(
        "--hidden_size", default=1024, type=int, help="Size of hidden layer"
    )
    parser.add_argument(
    ...
    if args.output_dir is None:
        ...
        args.output_dir = os.path.join(
            os.path.dirname(os.path.realpath(__file__)), args.output_dir
        )
